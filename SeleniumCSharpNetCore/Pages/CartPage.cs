namespace SeleniumCSharpNetCore.Pages
{
    public class CartPage : BasePage
    {
        ...
        private IWebElement BtnContinueShopping => DriverContext.Driver.FindElement(By.CssSelector("span[title='Continue shopping'] span:nth-child(1)"));
        ...
        public void SelectContinueToShopping() => BtnContinueShopping.ClickElement();
